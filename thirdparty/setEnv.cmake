...
IF(NOT Boost_FOUND)
    ...
    set(Boost_COMPILER "-vc100") #NOTE: We could also use "-${CMAKE_GENERATOR_TOOLSET}" here, but it returns -v100. The c is missing...
    set(Boost_DEBUG ON)
...
set( Pluma_LIBRARIES    optimized ${THIRDPARTY_DIR}/pluma/lib/pluma.lib
                        debug ${THIRDPARTY_DIR}/pluma/lib/pluma.lib)

#ZeroMQ
set( Zeromq_INCLUDE_DIRS    ${THIRDPARTY_DIR}/zmq/include)
set( Zeromq_LIBRARIES       optimized ${THIRDPARTY_DIR}/zmq/lib/libzmq-v100-mt-4_0_4.lib
                            debug ${THIRDPARTY_DIR}/zmq/lib/libzmq-v100-mt-4_0_4.lib)
